...
class PermutationIterable<S> implements Iterable<Tour<S>> {

    private static final class PermutationIterator<S> implements Iterator<Tour<S>> {
    ...
    @Override
    public Iterator<Tour<S>> iterator() {
