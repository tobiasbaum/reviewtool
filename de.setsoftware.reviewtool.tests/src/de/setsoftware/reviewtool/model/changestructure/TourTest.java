...
public class TourTest {
    ...
    public void testCannotMergeNeighboringStopsWithDifferentRelevance() {
        ...
        final Stop s1 = new Stop(new TextualChangeHunk(null, from1, to1, Classification.NONE), current1);
        ...
        final Stop s2 = new Stop(new TextualChangeHunk(null, from2, to2, IRRELEVANT), current2);
