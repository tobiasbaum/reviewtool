...
public interface IReviewElement {
    ...
    /**
     * Returns true if this element is visible. Invisible elements would have been filtered out if they did not take
     * part in the relevant change history. For example, if a file A was changed in revisions 1-3, and the revisions 1
     * and 3 belong to ticket A and revision 2 belongs to ticket B, and someone wants to analyze the changes of ticket
